...
y = train_data[['good_fit_bool', 'acquisition_chance', 'failure_chance', 'exit_amt', 'exit_time_period_yrs', 'potential_TAM', '2x_prob_1yr', '2x_prob_5yr', '10x_prob_1yr', '10x_prob_5yr']].copy()
